...
class Actor(nn.Module):
    ...
    def forward(
        ...
        act_neighboring_masks=act_neighboring_masks.reshape(batch_size,self.num_agents,-1)
        if actions is not None:
        ...
        if actions is None:
            ...
            if isinstance(self.action_space,Discrete):
                actions, action_log_probs, logits = discrete_autoregreesive_act(self.decoder, obs_rep, obs_rep, act_neighboring_masks, batch_size,
            ...
            if isinstance(self.action_space,Discrete):
                action_log_probs, entropy, logits = discrete_parallel_act(self.decoder, obs_rep, obs_rep, act_neighboring_masks, actions, batch_size,
