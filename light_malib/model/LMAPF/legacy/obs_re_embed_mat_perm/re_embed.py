...
class ReEmbed(nn.Module):
    def __init__(self):
        ...
        self.global_proj=nn.Conv2d(self.global_in_dim,self.hidden_dim,kernel_size=1)
        self.local_proj=nn.Linear(self.in_dim, self.hidden_dim)
        
        self.backbone=nn.Sequential(
            nn.LayerNorm([self.hidden_dim,self.FOV_height,self.FOV_width]),
            # 11,11 -> 9,9
    ...
    def forward(self, global_features, curr_positions, local_features):
        '''
