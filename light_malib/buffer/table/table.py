...
class Table:
    ...
    def write(self, samples):
        ...
        assert isinstance(samples, list) or isinstance(samples, np.ndarray), "error type: {}".format(type(samples))
    ...
    def read(self, n, timeout=None):
        ...
        assert n <= self.capacity,"n: {} vs capacity: {}".format(n,self.capacity)
