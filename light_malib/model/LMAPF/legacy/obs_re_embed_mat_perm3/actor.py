    ...
    def forward(
        ...
        if actions is None:
            ...
            if isinstance(self.action_space,Discrete):
                actions, action_log_probs, logits = discrete_autoregreesive_act(self.decoder, obs_rep, obs_rep, obs_neighboring_masks, batch_size,
            ...
            if isinstance(self.action_space,Discrete):
                action_log_probs, entropy, logits = discrete_parallel_act(self.decoder, obs_rep, obs_rep, obs_neighboring_masks, actions, batch_size,
