...
class ReEmbedGlobal(nn.Module):
    ...
    def forward(self, global_features, curr_positions, local_features):
        ...
        # B*A, 1, 1, Fg
        _local_features = global_features[batch_indices[:,0,0],:,curr_positions[...,0],curr_positions[...,1]]

        # B*A, Fl
        local_features = _local_features.view(B*A,-1)
